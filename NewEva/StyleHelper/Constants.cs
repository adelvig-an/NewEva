...
namespace NewEva.StyleHelper
{
    ...
    {
        public static readonly Thickness TextBoxDefaultPadding = new Thickness(8, 4, 8, 4);
        public static readonly Thickness TextBoxFloatingHintPadding = new Thickness(8, 12, 8, 0);
